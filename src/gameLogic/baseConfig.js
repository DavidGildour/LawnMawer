...
export const fieldSize = new Upgrade('fieldSize', 1000, buildRange(10, x => x + 10, x => x <= 400), 1.2);
export const growthRate = new Upgrade('growthRate', 10, buildRange(4, x => x + 2, x => x < 40), 1.6);