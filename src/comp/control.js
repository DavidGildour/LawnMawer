...
export default function Control(props) {
  const ticksPerSecond = (1000 / props.curTickRate)
    .toPrecision(4)
    .replace(/\.?0+$/, '');
  const currentTickRate = `${ticksPerSecond} ticks per second`,
    ...
    currentGrowthSpeed = `Tiles growing ${props.curGrowthSpeed} per tick`,
  ...
  return (
    <div className="green rounded upgrades">
      ...
      <UpgradeButton
        upgradeFunc={props.upgradeTick}
        text="Upgrade Tick Rate"
        currentPrice={props.tickRatePrice}
        currentValue={currentTickRate}
      />
      <UpgradeButton
        upgradeFunc={props.upgradeSize}
        text="Upgrade Field Size"
        currentPrice={props.sizePrice}
        currentValue={currentSize}
      />
      <UpgradeButton
        upgradeFunc={props.upgradeGrowth}
        text="Upgrade Growth Rate"
        currentPrice={props.growthRatePrice}
        currentValue={currentGrowthRate}
      />
      <UpgradeButton
        upgradeFunc={props.upgradeMawerSpeed}
        text="Upgrade Mawer Speed"
        currentPrice={props.mawerSpeedPrice}
        currentValue={currentMawerSpeed}
      />
      <UpgradeButton
        upgradeFunc={props.upgradeGrowthSpeed}
        text="Upgrade Grass Growth Speed"
        currentPrice={props.growthSpeedPrice}
        currentValue={currentGrowthSpeed}
      />
      <UpgradeButton
        upgradeFunc={props.upgradeMawerSize}
        text="Upgrade Mawer Size"
        currentPrice={props.mawerSizePrice}
        currentValue={currentMawerSize}
      />
      <UpgradeButton
        upgradeFunc={props.godMode}
        text="Add $$$"
        currentPrice={0}
